...
class empresa_cargoData {
	...
	public static function getEmpresaCargoDat($nid){
		$sql ="SELECT EC.nI, E.cNombre,EC.cCargo FROM empresa E
		JOIN empresa_cargo EC ON E.nId=EC.nIdEmpresa
		WHERE EC.nId =".$nid;
		$query = Executor::doit($sql);
	...
	public static function getCargosEmpresaId($idEmpresa){
		$sql = "SELECT EC.nId, E.cNombre,EC.cCargo FROM empresa E INNER JOIN empresa_cargo EC ON E.nId=EC.nIdEmpresa WHERE E.nId =".$idEmpresa;
